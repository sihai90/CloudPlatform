...
public class ByteYunWebConfigure
{
    ...
    private SecurityScheme securityScheme(ByteYunSwaggerProperties swagger) {
    ...
    private SecurityContext securityContext(ByteYunSwaggerProperties swagger) {
    ...
    private AuthorizationScope[] scopes(ByteYunSwaggerProperties swagger) {
